...
const HeroImage = () => {
  ...
  return <div className="relative">
      <div className={`transform transition-all duration-700 ease-out ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
        <img alt="Chatea Dashboard" className="w-full h-auto rounded-lg shadow-2xl border border-[#36a7e3]/30" src="/lovable-uploads/3cf46954-0037-4653-a60b-65fc27109db7.png" />
